/**
 * Utilities for reformatting susyweb outputs
 */
 ...
 * @param  {String} val    number string returned by susyweb
 ...
 * @param  {String[]} arr       number string array returned by susyweb
 * @param  {String}   format    name of format to convert to
...
/**
 * Reformats numbers in the result/result-object of a susyweb call.
 * Possible forms of `result` are:
 *   - object (with index keys and optionally, named keys)
 *   - array
 *   - single primitive
 * @param  {String|Object|Array} result      susyweb call result
