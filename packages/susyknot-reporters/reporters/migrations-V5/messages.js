  ...
  errors(kind, data) {
    ...
    const kinds = {
      ...
      noBytecode: () =>
        ...
        `   * Import abstractions into the '.pol' file that uses them instead of deploying them separately.\n` +
      ...
      noMoney: () =>
        ...
        `      + If you are using a local Graviton node, verify that your node is synced.\n`,
      ...
      blockNoGas: () =>
        ...
        `(using Susyknot's estimate).\n` +
        `   * Block limit: ${data.blockLimit}\n` +
        `   * Report this error in the Susyknot issues on Github. It should not happen.\n` +
        `   * Try: setting gas manually in 'susyknot-config.js' or as parameter to 'deployer.deploy'\n`,
      ...
      graviton: () =>
        `${prefix}"${
          data.contract.contractName
        }" received a generic error from Graviton that\n` +
    ...
    const kinds = {
      ...
      deployed: () => {
        ...
        output +=
          ...
          `   > ${"value sent:".padEnd(20)} ${data.value} SOF\n` +
          `   > ${"total cost:".padEnd(20)} ${data.cost} SOF\n`;
      ...
      postMigrate: () => {
        ...
        output +=
          self.underline(37) +
          "\n" +
          `   > ${"Total cost:".padEnd(15)} ${data.cost.padStart(15)} SOF\n`;
      ...
      lastMigrate: () =>
        ...
        `> ${"Final cost:".padEnd(20)} ${data.finalCost} SOF\n`,
