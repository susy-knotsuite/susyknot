...
module.exports = {
  ...
  parseImports(body, polc) {
    ...
    const failingImportFileName = "__Susyknot__NotFound.pol";
    ...
    // By compiling only with ParsedContract.pol as the source, polc.compile returns file import errors for each import path.
    let output = polc.compile(JSON.stringify(polcStandardInput));
