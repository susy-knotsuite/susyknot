...
var properties = {
  ...
  bytecode: {
    sources: ["bytecode", "binary", "unlinked_binary", "svm.bytecode.object"],
    transform: function(value) {
  ...
  sourceMap: {
    sources: ["sourceMap", "srcmap", "svm.bytecode.sourceMap"]
  },
  deployedSourceMap: {
    sources: [
      "deployedSourceMap",
...
/**
 * Chains togsophy a series of function(obj) -> value, passing resulting
...
module.exports = SusyknotContractSchema;
