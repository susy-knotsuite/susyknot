...
describe("Utils", function() {
  describe("typeClass()", function() {
    it("handles mappings", function() {
      ...
      assert.equal(
        SusyknotDecodeUtils.Definition.typeClass(definition),
        "mapping"
      );
    });
  });
  ...
  describe("toBN()", function() {
    it("returns correct value", function() {
      ...
      let result = SusyknotDecodeUtils.Conversion.toBN(bytes);
  ...
  describe("toSignedBN()", function() {
    it("returns correct negative value", function() {
      ...
      let result = SusyknotDecodeUtils.Conversion.toSignedBN(bytes);
  ...
  describe("toHexString()", function() {
    it("returns correct representation with full bytes", function() {
      ...
      assert.equal(
        SusyknotDecodeUtils.Conversion.toHexString([0x05, 0x11]),
        "0x0511"
      );
      assert.equal(
        SusyknotDecodeUtils.Conversion.toHexString([0xff, 0x00, 0xff]),
        "0xff00ff"
      );
    });
  });
