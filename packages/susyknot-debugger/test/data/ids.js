...
let sources = {
  "FactorialTest.pol": __FACTORIAL,
  "AddressTest.pol": __ADDRESS,
  "Intervening.pol": __INTERVENING,
  "InterveningLib.pol": __INTERVENINGLIB
};
...
describe("Variable IDs", function() {
  ...
  it("Distinguishes between stackframes", async function() {
    ...
    debug("sourceId %d", session.view(polynomial.current.source).id);
