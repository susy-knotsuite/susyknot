...
const controller = createSelectorTree({
  ...
  current: {
     ...
     */
    executionContext: createLeaf([svm.current.call], identity),

    /**
     * controller.current.willJump
     */
    willJump: createLeaf([svm.current.step.isJump], identity),
    ...
    location: {
      ...
      sourceRange: createLeaf(
        [polynomial.current.sourceRange, "/current/trace/loaded"],
       ...
       */
      source: createLeaf(
        [polynomial.current.source, "/current/trace/loaded"],
       ...
       */
      node: createLeaf(
        [polynomial.current.node, "/current/trace/loaded"],
      ...
      isMultiline: createLeaf(
        [polynomial.current.isMultiline, "/current/trace/loaded"],
  ...
  breakpoints: {
     ...
     */
    resolver: createLeaf([polynomial.info.sources], sources => breakpoint => {
