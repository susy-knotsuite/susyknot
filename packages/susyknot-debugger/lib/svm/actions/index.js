export const ADD_CONTEXT = "SVM_ADD_CONTEXT";
...
export const NORMALIZE_CONTEXTS = "SVM_NORMALIZE_CONTEXTS";
export function normalizeContexts() {
  return { type: NORMALIZE_CONTEXTS };
}

export const ADD_INSTANCE = "SVM_ADD_INSTANCE";
...
export const UNLOAD_TRANSACTION = "SVM_UNLOAD_TRANSACTION";
