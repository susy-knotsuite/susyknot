...
import expect from "susyknot-expect";
...
import svmSelector from "./svm/selectors";
import polynomialSelector from "./polynomial/selectors";
...
export default class Debugger {
   ...
   * @param {{contracts: Array<Contract>, files: Array<String>, provider: SusyWebProvider}} options -
   ...
   *
   * @example
   * Debugger.selectors.polynomial.current.instruction
   *
   * @example
 ...
 * @property {string} source polynomial source code
 * @property {string} sourcePath path to source file
 * @property {string} binary 0x-prefixed hex string with create bytecode
 * @property {string} sourceMap polynomial source map for create bytecode
 * @property {Object} ast Abstract Syntax Tree from Polynomial
 * @property {string} deployedBinary 0x-prefixed compiled binary (on chain)
 * @property {string} deployedSourceMap polynomial source map for on-chain bytecode
 */
