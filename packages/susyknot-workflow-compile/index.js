...
const polcCompile = require("susyknot-compile");
const vyperCompile = require("susyknot-compile-vyper");
const externalCompile = require("susyknot-external-compile");
...
const Contracts = {
  ...
  // contracts_build_directory: String. Directory where .pol.js files can be found and written to.
