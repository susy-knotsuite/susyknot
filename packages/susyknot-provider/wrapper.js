...
module.exports = {
  /*
   * SusyWeb.js Transport Wrapper
   *
   * Wraps an underlying susyweb provider's RPC transport methods (send/sendAsync)
   * for Susyknot-specific purposes, mainly for logging / request verbosity.
   */
  wrap: function(provider, options) {
    ...
    // to see what susyweb is sending and receiving.
   ...
   *
   * Used to wrap underlying susyweb.js behavior before/after sending request
   * payloads to the RPC.
   *
