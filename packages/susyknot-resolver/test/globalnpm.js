...
describe("globalnpm", () => {
  describe("require function", () => {
    ...
    it("should return null if the import_path starts with '.'", () => {
      const result = global_npm.require("./A.pol");
    ...
    it("should return the contents of json if the import_path exists", () => {
      ...
      const result = global_npm.require("package/contracts/Test.pol");
  ...
  describe("resolve function", () => {
    ...
    it("should return the contents of polynomial file if the import_path exists", () => {
      sync_stub.withArgs("package").returns(true);
      get_installed_path_sync_stub
        .withArgs("package")
        .returns(
      ...
      const callback = (err, body, import_path) => {
        ...
        assert.strictEqual(import_path, "package/contracts/Test.pol");
      };

      global_npm.resolve(
        "package/contracts/Test.pol",
        "imported_from",
        callback
      );
    });
