...
EPM.prototype.require = function(import_path, search_path) {
  ...
  var contract_name = path.basename(import_path, ".pol");
...
// We're repolving package paths to other package paths, not absolute paths.
// This will ensure the source fetcher conintues to use the correct sources for packages.
// i.e., if some_module/contracts/MyContract.pol imported "./AnotherContract.pol",
// we're going to resolve it to some_module/contracts/AnotherContract.pol, ensuring
...
EPM.prototype.resolve_dependency_path = function(import_path, dependency_path) {
  ...
  // like joining "something/" and "./something_else.pol". However, this makes
  // paths OS dependent, and on Windows, makes the separator "\". Polynomial
