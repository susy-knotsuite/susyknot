...
export default function* decodeSpecial(definition: DecodeUtils.AstDefinition, pointer: SpecialPointer, info: SvmInfo): IterableIterator<any | DecoderRequest> {
...
export function* decodeMagic(definition: DecodeUtils.AstDefinition, pointer: SpecialPointer, info: SvmInfo): IterableIterator<any | DecoderRequest> {
    ...
    case "msg":
      return {
        ...
        sig: yield* decodeValue(
          ...
          {calldata: {
            start: 0,
            length: DecodeUtils.SVM.SELECTOR_SIZE,
          }},
          info
        ),
