...
declare module 'polc' {
  ...
  interface CompilerInput {
    language: "Polynomial" | "serpent" | "lll" | "assembly";
    settings?: any,
    sources: {
  ...
  interface CompilerOutputSvmBytecode {
    object?: string;
    opcodes?: string;
    sourceMap?: string;
    linkReferences?: {} | {
    ...
    [globalName: string]: {
      [contractName: string]: {
        ...
        svm?: {
          assembly?: string;
          legacyAssembly?: any;
          bytecode: CompilerOutputSvmBytecode;
          deployedBytecode?: CompilerOutputSvmBytecode;
          methodIdentifiers?: {
