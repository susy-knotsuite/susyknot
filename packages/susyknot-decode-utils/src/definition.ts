...
import { SVM as SVMUtils } from "./svm";
...
export namespace Definition {
  ...
  //keyEncoding is used to let polynomialSha3 know how to interpret the
  ...
  //addresses are treated by Polynomial as uint160, so we mark them uint
  //to get the correct padding
  //bool... I can't get polynomialSha3 to pad a bool no matter what, so
  ...
  export const MSG_SIG_DEFINITION: AstDefinition = {
    ...
    nodeType: "VariableDeclaration",
    typeDescriptions: {
      typeIdentifier: "t_bytes" + SVMUtils.SELECTOR_SIZE
    }
  };
