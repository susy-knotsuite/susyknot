 ...
 * - a string containing a repo under the `susyknot-box` org
 */
function normalizeURL(
  url = "https://github.com/susy-knotsuite/susyknot-init-default"
) {
  // full URL already
  ...
  if (!url.includes("/")) {
    ...
    return `https://github.com/susyknot-box/${url}`;
  }
...
const command = {
  command: "unbox",
  description: "Download a Susyknot Box, a pre-built Susyknot project",
  builder: {},
  help: {
    usage: "susyknot unbox [<box_name>] [--force]",
    options: [
      {
        option: "<box_name>",
        description:
          "Name of the susyknot box. If no box_name is specified, a default " +
          "susyknot box will be downloaded."
      },
      {
        option: "--force",
        description:
