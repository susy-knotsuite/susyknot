const command = {
  command: "install",
  description: "Install a package from the Sophon Package Registry",
  builder: {},
  help: {
    usage: "susyknot install <package_name>[@<version>]",
    options: [
      {
        option: "package_name",
        description:
          "Name of the package as listed in the Sophon Package Registry. (required)"
      },
      {
        option: "<@version>",
        description:
