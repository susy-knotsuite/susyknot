...
var Develop = {
  ...
  connect: function(options, callback) {
    ...
    var debugRPC = debug("develop:susybraid");
    ...
    ipc.connectTo(ipcNetwork, connectPath, function() {
      ...
      ipc.of[ipcNetwork].on("susyknot.ready", function() {
  ...
  connectOrStart: function(options, susybraidOptions, callback) {
    var self = this;
    ...
    this.connect(
      ...
      function(error, disconnect) {
        if (error) {
          self.start(ipcNetwork, susybraidOptions, function() {
            options.retry = true;
            self.connect(
              options,
              function(error, disconnect) {
