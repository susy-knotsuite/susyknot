 ...
 * @requires module:susyknot-config
...
//set susyknotAnalyticsId depending on whether version is bundled
const susyknotAnalyticsId = version.bundle ? "UA-83874933-6" : "UA-83874933-7";
...
const analyticsInquiry = [
  {
    ...
    message:
      "Would you like to enable analytics for your Susyknot projects? Doing so will allow us to make sure Susyknot is working as expected and help us address any bugs more efficiently.",
...
const googleAnalytics = {
  ...
  setPersistentAnalyticsData: function() {
    if (this.checkIfAnalyticsEnabled() === true) {
      ...
      let visitor = ua(susyknotAnalyticsId, { cid: userId });
      return visitor;
    }
  },
